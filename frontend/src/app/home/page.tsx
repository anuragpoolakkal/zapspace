...
export default function Home() {
	...
	return (
		<div className="flex w-screen h-screen bg-[#DDC12D] flex-col text-black p-5">
			<nav className="flex justify-between mb-4">
				<p className="text-xl font-bold">Zapspace</p>
				{localStorage.getItem("user") ? (
					...
					<button
						...
						className="btn btn-primary bg-black text-white hover:bg-black hover:text-[#f0f0f0]"
					>
						Login
					</button>
				)}
					...
					<div className="flex px-8 h-full items-center justify-center mb-20">
						<div className="w-full h-full flex flex-col justify-center">
							...
							<div className="flex">
								<button
									onClick={(x) => signUp()}
									className="btn btn-neutral mt-7"
								>
									Signup
								</button>
							</div>
						...
						<Image
							src="https://cdn3d.iconscout.com/3d/premium/thumb/shopping-store-5130510-4292743.png"
							alt="icon"
							width={500}
							height={500}
						/>
			...
			{showOnboarding ? (
				<main
					style={{
						background:
							createBusinessData.category !== -1
								? businessCategories[
										createBusinessData.category
								  ].color
								: "#DDC12D",
					}}
					className="absolute left-0 top-0 w-full h-full flex flex-col p-5"
				>
					<nav className="flex w-full justify-between">
						<p className="text-xl font-bold">Zapspace</p>
						<FiX
					...
					<div className="flex px-8 h-full items-center justify-center">
						<div className="w-full h-full flex flex-col justify-center">
							<p>
								{onboardingIndex + 1} of{" "}
								{onboardingMessages.length}
							</p>
							<p className="text-2xl font-semibold mb-3">
								{onboardingMessages[onboardingIndex].title}
							</p>
							{onboardingIndex === 0 ? (
								<input
									type="text"
								...
								<textarea
									...
									value={createBusinessData.description}
								...
								<select
									onChange={(x) =>
										setCreateBusinessData({
											...createBusinessData,
											category: parseInt(x.target.value),
										})
									}
									className="select select-bordered w-full max-w-xs"
									value={createBusinessData.category}
								>
						...
						<Image
							src={
								createBusinessData.category !== -1
									...
									: "https://cdn3d.iconscout.com/3d/premium/thumb/shopping-store-5130510-4292743.png"
							}
							alt="icon"
							width={500}
							height={500}
			...
			{/* Onboarding */}
			{showOnboarding || showLogin || showSignUp ? (
				""
			) : (
				<div className="hero h-[90vh] w-full">
					{/* <img
						className="absolute object-cover w-full h-full"
						style={{ zIndex: "0", filter: "opacity(0.5)" }}
						src={
							businessData?.name
								? `${
										businessCategories[
								...
								: "https://images.unsplash.com/photo-1576500714954-8a687d0ea1ef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
						}
					/> */}
					<div className="hero-content flex-col lg:flex-row">
							...
							<img
								...
								src={
									businessData?.name
										...
										: "https://static.vecteezy.com/system/resources/previews/011/997/009/non_2x/online-shop-3d-icon-illustration-for-your-website-user-interface-and-presentation-3d-render-illustration-free-png.png"
								}
						...
						<div className="content-center">
							<h1 className="max-w-[70%] text-3xl text-black font-bold">
								{businessData.name
									? `Welcome ${businessData.name}!`
									: "Put your business on the Internet with ease, in just a few clicks!"}
							</h1>
							<p className="text-black font-{800} py-6">
								{businessData.name
									? "Take control of your business with ease - visit your personalized dashboard to effortlessly manage and monitor your products, sales, and more, all in one convenient place."
									: "Turn your dreams into reality with Zapspace - the fastest and easiest way to start and launch your own business in minutes."}
							</p>
							<button
								className="btn btn-primary bg-black text-white hover:bg-black"
								onClick={() => {
